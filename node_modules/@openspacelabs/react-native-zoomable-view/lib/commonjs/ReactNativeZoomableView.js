...
class ReactNativeZoomableView extends _react.Component {
  ...
  constructor(props) {
    ...
    _defineProperty(this, "_handlePanResponderEnd", (e, gestureState) => {
      ...
      this.lastGestureCenterPosition = null; // Trigger final shift animation unless panEnabled is false or disablePanOnInitialZoom is true and we're on the initial zoom level

      if (this.props.panEnabled && !(this.gestureType === 'shift' && this.props.disablePanOnInitialZoom && this.zoomLevel === this.props.initialZoom)) {
    ...
    this.gestureHandlers = _reactNative.PanResponder.create({
      ...
      onStartShouldSetPanResponderCapture: (evt, gestureState) => {
        var _this$props$onStartSh, _this$props10;

        return (_this$props$onStartSh = (_this$props10 = this.props).onStartShouldSetPanResponderCapture) === null || _this$props$onStartSh === void 0 ? void 0 : _this$props$onStartSh.call(_this$props10, evt, gestureState);
      },
      onMoveShouldSetPanResponderCapture: (evt, gestureState) => {
        var _this$props$onMoveSho, _this$props11;

        return (_this$props$onMoveSho = (_this$props11 = this.props).onMoveShouldSetPanResponderCapture) === null || _this$props$onMoveSho === void 0 ? void 0 : _this$props$onMoveSho.call(_this$props11, evt, gestureState);
      }
    });
  ...
  _invokeOnTransform() {
    var _this$props$onTransfo, _this$props12;
